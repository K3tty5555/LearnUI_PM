...
当前产品在原有 UI 词典和视觉风格图鉴之外，增加页面参考库，并在知名网站图鉴中整合网站级 DESIGN.md。主场景是“看样例、选方向、说清楚”：面向产品经理、设计师和 AI 原型开发者，中文默认，允许混合选择页面参考、知名网站设计规范、UI 元素和视觉风格并导出结构化说明。新增内容与上游数据分目录管理。
